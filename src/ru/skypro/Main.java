...
public class Main {
    ...
    public static void main ( String[] args ) {
        Gryffindor Harry = new Gryffindor("Гарри Поттер", 100, 4, 78, 67, 99);
        Gryffindor Hermione = new Gryffindor("Гермиона Грейнджер", 55, 4, 50, 90, 78);
        Gryffindor Ronald = new Gryffindor("Рон Уизли", 21, 4, 78, 49, 99);

        Slytherin Malfoy = new Slytherin("Драко Малфой", 59, 23, 54, 21, 90, 88, 45);
        Slytherin Montegru = new Slytherin("Грэхэм Монтегю", 45, 89, 22, 21, 90, 11, 45);
        ...
        Gryffindor.gryffindorComparison(Harry, Ronald);
        RavenClaw.ravenClawComparison(Padma, Markus);
        Hufflepuff.hufflepuffComparison(Diggory,Finch);
        Slytherin.slytherinComparison(Malfoy, Montegru);
